...
- An open source Android app which blocks pornographic domain lookup (DNS, not a firewall), effectively controlling the information flow in and out of an Android phone, blocking evil, toxic and ponographic websites.

- How it works: It blocks known pornographic domains. Popular websites containing pornographic material are blocked, including: X, Reddit and Wikipedia images. Safe search is enforced on Google while all other search engines are blocked.
